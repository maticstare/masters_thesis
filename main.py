...
wagon = TrainWagon(width=2000, height=5000, depth=6000, center=(0, 0, 0), color="blue")

simulate_wagon_movement(plotter, control_points, wagon, control_points_offset, speed=0.001, export_mp4=False)
