...
Vagon je modeliran kot pravokotno telo (kvader) z dimenzijami širina $w$, višina $h$ in globina $d$. Geometrijska predstavitev temelji na konceptu medosne razdalje in ortogonalnem koordinatnem sistemu. Na spodnji sliki je razvidno, kako je vagon postavljen v prostoru.

\begin{figure}[H]
    \centering
    \includegraphics[width=11cm]{wheelbase.png}
    \caption{
        Postavitev vagona v prostoru z označenima točkama $\boldsymbol{p}_0$ in $\boldsymbol{p}_1$, ki predstavljata njegove osi.
    }\label{fig:wheelbase}
\end{figure}
...
\begin{itemize}
    \item \textbf{Ringo}: dolžina 123 m, enostavna geometrija, vertikalni odmik tirnic 1800 mm, odmik središča predora 3700 mm.
        \begin{figure}[h!]
            \centering
            \includegraphics[width=9cm]{ringo.png}
            \caption{
                Prikaz ravne geometrije predora Ringo z B-zlepki sten.
            }\label{fig:ringo}
        \end{figure}
    \item \textbf{Globoko}: dolžina 235 m, zahtevnejša geometrija, največja dovoljena višina vlaka 4900 mm, brez dodatnih poravnav.
        \begin{figure}[h!]
            \centering
            \includegraphics[width=9cm]{globoko.png}
            \caption{
                Prikaz ukrivljene geometrije predora Globoko z B-zlepki sten.
            }\label{fig:globoko}
        \end{figure}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Enostavna zaboja}: Tovor je sestavljen iz dveh zabojev, postavljenih eden na drugega.
        \begin{figure}[h!]
            \centering
            \includegraphics[width=9cm]{simple_cargo.png}
            \caption{
                Prikaz prvega testnega tovora v obliki enostavnih zabojev.
            }\label{fig:simple_cargo}
        \end{figure}
    \item \textbf{Tovor v obliki jadra}: Tovor je v obliki jadrniškega jadra.
        \begin{figure}[h!]
            \centering
            \includegraphics[width=9cm]{sail_cargo.png}
            \caption{
                Prikaz drugega testnega tovora v obliki jadrniškega jadra.
            }\label{fig:sail_cargo}
        \end{figure}
\end{itemize}
...
Najprej smo izvedli prileganje tovora v prilagojeni model vagona predora Ringo.

\begin{itemize}
    \item \textbf{Enostavna zaboja}: Tovor, ki je sestavljen iz dveh zabojev, postavljenih eden na drugega, se uspešno prilega znotraj prilagojenega modela z rotacijo yaw=0°, pitch=45° in roll=0°.
        \begin{figure}[H]
            \centering
            \includegraphics[width=9cm]{simple_ringo.png}
            \caption{
                Prikaz prileganja prvega testnega tovora v prilagojeni model predora Ringo.
            }\label{fig:simple_ringo}
        \end{figure}
    \item \textbf{Tovor v obliki jadra}: Tovor, ki je v obliki jadrniškega jadra, se prav tako uspešno prilega znotraj prilagojenega modela z rotacijo yaw=0°, pitch=45° in roll=0°.
        \begin{figure}[H]
            \centering
            \includegraphics[width=9cm]{sail_ringo.png}
            \caption{
                Prikaz prileganja drugega testnega tovora v prilagojeni model predora Ringo.
            }\label{fig:sail_ringo}
        \end{figure}
\end{itemize}

Za tem smo izvedli tudi prileganje tovora v prilagojen model vagona predora Globoko.


\begin{itemize}
    \item \textbf{Enostavna zaboja}: Tovor, ki je sestavljen iz dveh zabojev, postavljenih eden na drugega, se v nobeni postavitvi ne prilega znotraj prilagojenega modela.
        \begin{figure}[H]
            \centering
            \includegraphics[width=9cm]{simple_globoko.png}
            \caption{
                Prikaz neuspešnega prileganja prvega testnega tovora v prilagojeni model predora Globoko.
            }\label{fig:simple_globoko}
        \end{figure}
    \item \textbf{Tovor v obliki jadra}: Tovor, ki je v obliki jadrniškega jadra, pa se uspešno prilega znotraj prilagojenega modela z rotacijo yaw=0°, pitch=0° in roll=45°.
        \begin{figure}[H]
            \centering
            \includegraphics[width=9cm]{sail_globoko.png}
            \caption{
                Prikaz prileganja drugega testnega tovora v prilagojeni model predora Globoko.
            }\label{fig:sail_globoko}
        \end{figure}
\end{itemize}
...
Geometrijski model vagona je omejen na pravokotno telo, kar ne ustreza vsem tipom železniških vozil. Kompleksnejši tovori z nepravilnimi oblikami zahtevajo naprednejše modeliranje ali uporabo 3D modelov iz datotek STL.
...
Razvoj algoritmov za vzporedno obdelavo bi izboljšalo računsko učinkovitost. Uporaba GPU računanja ali distribuiranih sistemov bi omogočila obdelavo večjih oblakov točk v realnem času.
