...
\section{Opis testnih predorov}
\label{sec:opis-predorov}

Testiranje je izvedeno na dveh predorih:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Vizualizacija STL}: simulacija s 3D modelom iz STL datoteke. Namenjena je testiranju vizualizacije.
\end{itemize}
