...
V tem poglavju predstavljamo tehnično realizacijo sistema za zaznavanje trkov med vlakom in predorom. Implementacija sledi metodološkemu pristopu iz poglavja~\ref{ch:metodologija} in je zasnovana kot modularen sistem s šestimi ključnimi komponentami.
...
Skripta \texttt{main.py} služi kot glavna vstopna točka sistema in koordinira delovanje vseh modulov. Omogoča izbiro med različnimi predori, nastavljanje parametrov ter zagon simulacije z vizualizacijo.
