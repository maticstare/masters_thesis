...
\floatname{algorithm}{\footnotesize Algoritem} % SLO: napis "Algoritem #" v krepkem tisku
...
\usepackage{booktabs}
% SLO: omogoča združevanje vrstic v tabelah
% ENG: allows merging rows in tables
\usepackage{multirow}
...
% SLO: dovoli prelom vrstice za podčrtajem znotraj \texttt, da se dolgi identifikatorji ne razširjajo čez rob
% ENG: allow line breaks after underscores inside \texttt so long snake_case identifiers don't overflow
\makeatletter
\let\orig@texttt\texttt
\let\orig@underscore\_
\renewcommand{\texttt}[1]{%
  \begingroup
  \renewcommand{\_}{\orig@underscore\allowbreak}%
  \orig@texttt{#1}%
  \endgroup
}
\makeatother
